...
document.querySelector("#go").addEventListener("click", function () {
    ...
    if(keyword){
        $.ajax( {
            type: 'GET',
            dataType: 'json',
            url: "https://crossorigin.me/https://en.wikipedia.org/w/api.php?action=opensearch&search=" + keyword + "&limit=10&format=json",
            success: function(responseText,statusText,xhr) {
                ...
                console.log(typeof responseText[1][0] !== "undefined");
                ...
                console.log(typeof responseText[1][1] !== "undefined");
                ...
                console.log(typeof responseText[1][2] !== "undefined");
                ...
                console.log(typeof responseText[1][3] !== "undefined");
                ...
                console.log(typeof responseText[1][4] !== "undefined");
                ...
                console.log(typeof responseText[1][5] !== "undefined");
                ...
                console.log(typeof responseText[1][6] !== "undefined");
                ...
                console.log(typeof responseText[1][7] !== "undefined");
                ...
                console.log(typeof responseText[1][8] !== "undefined");
                ...
                console.log(typeof responseText[1][9] !== "undefined");
...
/*WikipediaViewer*/
/*
$.getJSON("https://crossorigin.me/https://en.wikipedia.org/w/api.php?action=opensearch&search=javascript&limit=10&format=json", function (responsetext,statusText,xhr) {
